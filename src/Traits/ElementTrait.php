...
trait ElementTrait
{
     ...
     * 基础页面
     *
     * @return \DagaSmart\BizAdmin\Renderers\Page
     */
     ...
     * 返回列表按钮
     *
     * @return \DagaSmart\BizAdmin\Renderers\OtherAction
     */
     ...
     *
     * @return \DagaSmart\BizAdmin\Renderers\DialogAction|\DagaSmart\BizAdmin\Renderers\LinkAction
     */
     ...
     * @param string            $dialogSize 弹窗大小, 默认: md, 可选值: xs | sm | md | lg | xl | full
     *
     * @return \DagaSmart\BizAdmin\Renderers\Operation
     */
     ...
     * 基础筛选器
     *
     * @return \DagaSmart\BizAdmin\Renderers\Form
     */
     ...
     * 基础筛选器 - 条件构造器
     *
     * @return \DagaSmart\BizAdmin\Renderers\ConditionBuilderControl
     */
    ...
    /**
     * @return \DagaSmart\BizAdmin\Renderers\CRUDTable
     */
     ...
     *
     * @return \DagaSmart\BizAdmin\Renderers\Service
     */
