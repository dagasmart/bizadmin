                ...
                amis()->Flex()
                    ...
                    ->items([
                        ...
                        amis()->Flex()->className('w-full mt-5')->justify('center')->items([
                            $link('GitHub', 'https://github.com/dagasmart/bizadmin'),
                            $link('Official website', 'https://biz.dagasmart.com'),
                            $link('Documentation', 'https://doc.biz.dagasmart.com'),
                            $link('Demo', 'https://demo.biz.dagasmart.com'),
                        ]),
                    ]),
            ])
