...
namespace DagaSmart\BizAdmin\Controllers\DevTools;

use DagaSmart\BizAdmin\Admin;
use Illuminate\Support\Str;
use Illuminate\Support\Arr;
use Illuminate\Http\Request;
use DagaSmart\BizAdmin\Services\AdminMenuService;
use DagaSmart\BizAdmin\Traits\IconifyPickerTrait;
use DagaSmart\BizAdmin\Controllers\AdminController;
use DagaSmart\BizAdmin\Support\CodeGenerator\Generator;
use DagaSmart\BizAdmin\Services\AdminCodeGeneratorService;
use DagaSmart\BizAdmin\Support\CodeGenerator\GenCodeClear;
use DagaSmart\BizAdmin\Support\CodeGenerator\FilterGenerator;
...
class CodeGeneratorController extends AdminController
{
    ...
    public function getPropertyOptions(Request $request)
    {
        ...
        $className = '\\DagaSmart\\BizAdmin\\Renderers\\' . $request->c;
     ...
     * 字段表单
     *
     * @return \DagaSmart\BizAdmin\Renderers\Card
     */
     ...
     * 预览代码 按钮
     *
     * @return \DagaSmart\BizAdmin\Renderers\DialogAction
     */
