...
use DagaSmart\BizAdmin\Support\Cores\Api;
use DagaSmart\BizAdmin\Services\AdminApiService;
use DagaSmart\BizAdmin\Support\Apis\AdminBaseApi;
...
class ApiController extends AdminController
{
    ...
    public function addTemplate()
    {
        ...
        if (!$className) {
            $className = Str::between($template, 'class ', ' extends \DagaSmart\BizAdmin\Support\Apis\AdminBaseApi');
        }
