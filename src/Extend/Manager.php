...
namespace DagaSmart\BizAdmin\Extend;
...
use DagaSmart\BizAdmin\Support\Zip;
use Illuminate\Support\Collection;
use DagaSmart\BizAdmin\Support\Helper;
use Illuminate\Filesystem\Filesystem;
use DagaSmart\BizAdmin\Support\Composer;
use Illuminate\Contracts\Container\Container;
use Psr\Container\NotFoundExceptionInterface;
use Psr\Container\ContainerExceptionInterface;
use DagaSmart\BizAdmin\Models\Extension as ExtensionModel;
...
class Manager
{
    ...
    public function resolveExtension(string $directory, bool $addPsr4 = true)
    {
        ...
        $serviceProvider = $composerProperty->get('extra.bizadmin');
    ...
    protected function checkFiles($directory)
    {
        ...
        if (!$composerProperty->name || !$composerProperty->get('extra.bizadmin')) {
            return false;
        }
