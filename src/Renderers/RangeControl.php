...
class RangeControl extends BaseRenderer
{
    ...
    /**
     * 标签方向 (标签方向) 可选值: auto | top | right | bottom | left
     */
     ...
     * 表单项类型
     */
    public function type($value = 'input-range')
    {
    ...
    /**
     * 滑块值 (Range 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/range)
     */
