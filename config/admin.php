...
return [
    ...
    'auth' => [
        ...
        'providers'        => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => \DagaSmart\BizAdmin\Models\AdminUser::class,
            ],
        ],
        'except'           => [
    ...
    'models' => [
        'admin_user'       => \DagaSmart\BizAdmin\Models\AdminUser::class,
        'admin_role'       => \DagaSmart\BizAdmin\Models\AdminRole::class,
        'admin_menu'       => \DagaSmart\BizAdmin\Models\AdminMenu::class,
