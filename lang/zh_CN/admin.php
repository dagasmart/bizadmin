...
return [
    ...
    'code_generators' => [
        ...
        'dialog_form'                 => '弹窗表单',
        'copy_record'                 => '复制记录',
        'copy_record_description'     => '你可以复制后分享到 <a href="https://github.com/dagasmart/bizadmin/discussions/categories/%E4%BB%A3%E7%A0%81%E7%94%9F%E6%88%90%E8%AE%B0%E5%BD%95" target="_blank">Github</a>',
        'import_record'               => '导入记录',
        'import_record_placeholder'   => '请输入导入的json记录',
        'import_record_desc'          => '你可以在 <a href="https://github.com/dagasmart/bizadmin/discussions/categories/%E4%BB%A3%E7%A0%81%E7%94%9F%E6%88%90%E8%AE%B0%E5%BD%95" target="_blank">Github</a> 找到一些其他人分享的记录',
        'load_config'                 => '加载配置',
    ...
    'admin_role'  => [
        ...
        'name_slug_already_exists' => '角色名称和标识已存在',
    ...
    'admin_permission'  => [
        ...
        'name_slug_already_exists' => '权限名称和标识已存在',
    ],
    ...
    'admin_menu'  => [
        ...
        'url_exists'             => '菜单路径重复',
        'is_publicly'            => '开放方式',
        'is_publicly_description'=> '（请根据实际需要选择合适的开放方式）',
        'is_publicly_yes'        => '对所有人开放',
        'is_publicly_no'         => '仅对自己开放',
    ],
...
',
        ...
        'form'               => [
            ...
            'alias_placeholder'     => '例: OA办公',
            'describe_placeholder'  => '描述或说明一下扩展程序的使用场景或功能',
        ],
        'card'               => [
            'author'   => '作者',
            'version'  => '版本',
